...
<html lang="en">
    <head>
        ...
        <link href="http://localhost:8888/wp-content/themes/hello-elementor/account/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
        <link href="http://localhost:8888/wp-content/themes/hello-elementor/account/assets/plugins/font-awesome/css/all.min.css" rel="stylesheet">
        <link href="http://localhost:8888/wp-content/themes/hello-elementor/account/assets/plugins/perfectscroll/perfect-scrollbar.css" rel="stylesheet">
        <link href="http://localhost:8888/wp-content/themes/hello-elementor/account/assets/plugins/apexcharts/apexcharts.css" rel="stylesheet">

      
        <!-- Theme Styles -->
        <link href="http://localhost:8888/wp-content/themes/hello-elementor/account/assets/css/main.min.css" rel="stylesheet">
        <link href="http://localhost:8888/wp-content/themes/hello-elementor/account/assets/css/custom.css" rel="stylesheet">
    ...
    <body>
                  ...
                  <div class="" id="navbarNav">
                    ...
                    <div class="" id="headerNav">
                      <ul class="navbar-nav">
                              ...
                              <div class="header-notif">
                                <div class="notif-image">
                                  <span class="notification-badge">
                                    <img src="http://localhost:8888/wp-content/themes/hello-elementor/account/assets/images/avatars/profile-image.png" alt="">
                                  </span>
                                </div>
                                <div class="notif-text">
                                  <p>faucibus dolor in commodo lectus mattis</p>
                        ...
                        <li class="nav-item dropdown">
                          <a class="nav-link profile-dropdown" href="#" id="profileDropDown" role="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="http://localhost:8888/wp-content/themes/hello-elementor/account/assets/images/avatars/profile-image.png" alt=""></a>
            ...
            <div class="page-sidebar">
                <ul class="list-unstyled accordion-menu">
                  ...
                  <li class="active-page">
                    <a href="index.html"><i data-feather="home"></i>Overview</a>
                  </li>
                   <li>
                    <a href="index.html"><i data-feather="home"></i>My Profile</a>
                  </li>
                  <li>
                    <a href="email.html"><i data-feather="inbox"></i>Messages</a>
                  </li>
                  <li>
                    <a href="social.html"><i data-feather="user"></i>Withdrawals</a>
                  </li><li>
        ...
        <!-- Javascripts -->
        <script src="http://localhost:8888/wp-content/themes/hello-elementor/account/assets/plugins/jquery/jquery-3.4.1.min.js"></script>
        <script src="https://unpkg.com/@popperjs/core@2"></script>
        <script src="http://localhost:8888/wp-content/themes/hello-elementor/account/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
        <script src="https://unpkg.com/feather-icons"></script>
        <script src="http://localhost:8888/wp-content/themes/hello-elementor/account/assets/plugins/perfectscroll/perfect-scrollbar.min.js"></script>
        <script src="http://localhost:8888/wp-content/themes/hello-elementor/account/assets/plugins/apexcharts/apexcharts.min.js"></script>
        <script src="http://localhost:8888/wp-content/themes/hello-elementor/account/assets/js/main.min.js"></script>
        <script src="http://localhost:8888/wp-content/themes/hello-elementor/account/assets/js/pages/dashboard.js"></script>
    </body>
</html>